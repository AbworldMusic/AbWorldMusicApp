...
<div class="d-flex h-100 w-100">
    ...
    <div class="h-100 w-100"> 
        <div class="w-100 bg-white p-3 h-100">
            ...
            <div class="tab-content bg-white h-100" id="pills-tabContent">
                
                <div class="tab-pane fade show active bg-white h-100" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                ...
                <div class="tab-pane fade bg-white h-100" id="pills-new" role="tabpanel" aria-labelledby="pills-new-tab">
                    <div class="m-3 pt-4  col-sm-12 col-lg-6">
                        <form action="add_new_student.php" method='post' class='form-group'>
                            ...
                            <label for="studentAge" class="font-label mt-0">Student Age</label>
